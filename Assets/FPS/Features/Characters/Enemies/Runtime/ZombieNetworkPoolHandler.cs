...
namespace FPS
{
    public class ZombieNetworkPoolHandler : INetworkPrefabInstanceHandler
    {
        ...
        public NetworkObject Instantiate(ulong ownerClientId, Vector3 position, Quaternion rotation)
        {
            ...
            // NGO synchronizes NetworkBehaviours immediately after the prefab
            // handler returns. A pooled object must be active before that point;
            // otherwise NetworkTransform/NetworkVariable payloads are read against
            // a disabled object and reconnects can produce behaviour-size mismatch.
            obj.SetActive(true);
