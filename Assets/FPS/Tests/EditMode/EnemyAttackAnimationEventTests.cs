...
namespace FPS.Tests
{
    public class EnemyAttackAnimationEventTests
    {
        ...
        {
            "Assets/FPS/Features/Characters/Content/Enemies/ZombieAnimation/Prefabs/ZombieAnim.controller",
            "Assets/FPS/Features/Characters/Content/Enemies/Screamer/Animations/Screamer.controller"
        };
