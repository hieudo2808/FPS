...
namespace FPS.Tests
{
    public class PrefabValidationTests
    {
        ...
        public void EnemyPrefabs_HaveRequiredNetworkAndNavigationComponents()
        {
            string[] prefabPaths =
            {
                "Assets/Prefabs/Enemies/ZombiegirlW/Zombiegirl W Kurniawan.prefab",
                "Assets/Prefabs/Enemies/Copzombie/copzombie_l_actisdato.prefab",
                "Assets/Prefabs/Screamer/Prefabs/BookHeadMonster_withBlood.prefab"
            };
