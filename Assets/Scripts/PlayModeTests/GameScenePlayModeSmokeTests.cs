...
namespace FPS.PlayModeTests
{
    public class GameScenePlayModeSmokeTests
    {
        ...
        {
            yield return LoadAndAssertScene("Assets/Scenes/MainMenu.unity", "MainMenu");
            yield return LoadAndAssertScene("Assets/Scenes/LobbyScene.unity", "LobbyScene");
            yield return LoadAndAssertScene("Assets/Scenes/GameScene.unity", "GameScene");
